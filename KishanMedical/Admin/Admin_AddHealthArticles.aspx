<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true"
    CodeFile="Admin_AddHealthArticles.aspx.cs" Inherits="Admin_Admin_AddHealthArticles" %>
        ...
        <fieldset style="width: auto; height: auto; background-color: #d5fefd; background-image: linear-gradient(315deg, #d5fefd 0%, #fffcff 74%);">
            ...
            <center>
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="Label3" runat="server" Text="Description:-" Style="font-size: large"></asp:Label>
                        </td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label2" runat="server" Text="Title:-" Style="font-size: large"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txttitle" runat="server" Height="44px" Width="347px"></asp:TextBox>
                            <br />
                            <asp:RequiredFieldValidator ID="RFV3" runat="server" ErrorMessage="Please Enter Title.."
                    ...
                    <tr>
                        ...
                        <td style="width: 375px">
                            <asp:FileUpload ID="Ha_FileUpload" runat="server" Width="357px" Height="30px" Style="font-size: large" />
                            <br />
                            <asp:RequiredFieldValidator ID="RFV2" runat="server" ErrorMessage="Choose Image..."
                                Text="Choose Image..." ControlToValidate="Ha_FileUpload" ForeColor="Red"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
