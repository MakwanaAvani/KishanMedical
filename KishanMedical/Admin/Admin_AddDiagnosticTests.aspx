<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true"
    CodeFile="Admin_AddDiagnosticTests.aspx.cs" Inherits="Admin_AddDiagnosticTests" %>
        ...
        <fieldset style="width: auto; height: auto; background-color: #d5fefd; background-image: linear-gradient(315deg, #d5fefd 0%, #fffcff 74%);">
            ...
            <center>
                <table>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label1" runat="server" Text="Description2:-" Style="font-size: large"></asp:Label>
                        </td>
                        <td style="width: 375px">
                    ...
                    <tr>
                        ...
                        <td style="width: 375px">
                            <asp:FileUpload ID="Dt_FileUpload" runat="server" Width="357px" Height="30px" Style="font-size: large" />
                            <br />
                            <asp:RequiredFieldValidator ID="RFV2" runat="server" ErrorMessage="Choose Image..."
                                Text="Choose Image..." ControlToValidate="Dt_FileUpload" ForeColor="Red"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
