<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true"
    CodeFile="Admin_AddFranchise.aspx.cs" Inherits="Admin_Admin_AddFranchise" %>
            ...
            <center>
                <table>
                    ...
                    <tr>
                        ...
                        <td style="width: 375px">
                            <asp:FileUpload ID="Fr_FileUpload" runat="server" Width="357px" Height="30px" Style="font-size: large" />
                            <br />
                            <asp:RequiredFieldValidator ID="RFV2" runat="server" ErrorMessage="Choose Image..."
                                Text="Choose Image..." ControlToValidate="Fr_FileUpload" ForeColor="Red"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
